        ...
        <div className="font-sans bg-mauve min-h-[100vh] w-full">
            <div className="min-h-[55vh] flex justify-center items-end mb-12">
                <div className="flex flex-col justify-center items-center pt-12 gap-12">
                    <h1 className="text-light text-bold text-8xl p-8 rounded-xl relative">Chase Jenkins <span className="absolute top-0 left-0 w-8 h-8 border-t-8 border-l-8 border-light"></span>
            {/* Bottom-Right Corner Border */}
            <span className="absolute bottom-0 right-0 w-8 h-8 border-b-8 border-r-8 border-light"></span></h1>
